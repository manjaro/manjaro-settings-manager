...
bool
Global::getLanguagePackages( QList<Global::LanguagePackage>* availablePackages, QList<Global::LanguagePackage>* installedPackages )
{
 ...
 */
QByteArray
Global::performQuery( const QStringList args )
{
    QByteArray result( "" );
    QProcess pacman;
 ...
 */
QByteArray
Global::performQuery( const QString& args )
{
    QByteArray result( "" );
    QProcess pacman;
 ...
 */
QByteArray
Global::packageInformation( const QString& pkgName, bool foreignPackage = false )
{
    QStringList args;
 ...
 */
QString
Global::extractFieldFromInfo( const QString& field, const QString& pkgInfo )
{
 ...
 */
QString
Global::packageVersion( const QString& pkgInfo )
{
