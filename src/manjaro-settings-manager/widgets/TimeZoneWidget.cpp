    ...
    QWidget(parent)
{
    ...
    // Images
    background = QImage(":/images/resources/timezone/bg.png").scaled(X_SIZE, Y_SIZE, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    pin = QImage(":/images/resources/timezone/pin.png");
    ...
    for (int i = 0; i < zones.size(); ++i) {
        timeZoneImages.append(QImage(":/images/resources/timezone/timezone_" + zones.at(i) + ".png").scaled(X_SIZE, Y_SIZE, Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
    }
    LocaleGlobal::init();
}
